...
fn main() {
    ...
    //     .status();
    cc::Build::new()
        .files(&["src/custom_groestl/groestl256/hash.c", "src/custom_groestl/groestl256/bs.c" ]) // Include both C files
        .include("src/custom_groestl/groestl256") // Include the directory containing the headers
